...
(function () {
  ...
  const DICT = {
    ...
    "eq.a11y.markedMissing": { en: "{item} marked as not available", ru: "{item}: отмечено как отсутствующее" },
    "eq.a11y.markedAvailable": { en: "{item} marked as available", ru: "{item}: отмечено как доступное" },
