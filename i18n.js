...
(function () {
  ...
  const DICT = {
    ...
    "eq.a11y.floorLocked": { en: "Floor only on. Equipment list locked — bodyweight floor exercises only.", ru: "Режим «только пол» включён. Список инвентаря заблокирован — только упражнения с собственным весом на полу." },
    "eq.a11y.floorUnlocked": { en: "Floor only off. Equipment list active.", ru: "Режим «только пол» выключен. Список инвентаря активен." },
