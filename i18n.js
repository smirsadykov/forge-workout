...
(function () {
  ...
  const DICT = {
    ...
    "gen.equipment": { en: "Equipment you have", ru: "Что у тебя есть" },
    "eq.optinIntro": {
      en: "Tap everything you have. Bodyweight is always included.",
      ru: "Отметь всё, что у тебя есть. Свой вес всегда включён.",
    },
    ...
    "eq.a11y.added": { en: "{item} added", ru: "{item}: добавлено" },
    "eq.a11y.removed": { en: "{item} removed", ru: "{item}: убрано" },
    "eq.a11y.floorLocked": { en: "Floor only on. Bodyweight floor exercises only; pick any gear to switch out of it.", ru: "Режим «только пол» включён. Только упражнения с собственным весом на полу; выбери инвентарь, чтобы выйти." },
    "eq.a11y.floorUnlocked": { en: "Floor only off.", ru: "Режим «только пол» выключен." },
    ...
    // ─── Paywall (FORGE Pro) ─────────────────────────────────────────
    "paywall.title": { en: "Unlock unlimited training", ru: "Тренировки без лимита" },
    "paywall.sub": { en: "Train without limits.", ru: "Тренируйся без ограничений." },
    "paywall.limitReached": {
      en: "You've used all 3 free saves this week. Upgrade to keep logging without limits.",
      ru: "Все 3 бесплатных сохранения на этой неделе использованы. Подписка снимет лимит.",
    },
    "paywall.guidedComplete": {
      en: "Your last 3 sessions are saved. Upgrade now to keep this one too — and every workout going forward.",
      ru: "Последние 3 сессии уже сохранены. Подпишись, чтобы сохранить эту — и все следующие.",
    },
    "paywall.feat1": { en: "Save unlimited workouts to history", ru: "Сохраняй сколько угодно тренировок в историю" },
    "paywall.feat2": { en: "Smart intensity, body map, program mode", ru: "Smart intensity, карта тела, программа" },
    "paywall.feat3": { en: "Auto-progression when you've outgrown a lift", ru: "Авто-прогрессия когда упражнение стало лёгким" },
    "paywall.feat4": { en: "Cross-device sync — iOS, Android, web", ru: "Синхрон между устройствами — iOS, Android, web" },
    "paywall.monthly": { en: "Monthly", ru: "Месяц" },
    "paywall.annual": { en: "Annual", ru: "Год" },
    "paywall.perMonth": { en: "per month", ru: "в месяц" },
    "paywall.perYear": { en: "per year · $2.50/mo", ru: "в год · ~$2.50/мес" },
    "paywall.bestValue": { en: "BEST VALUE · SAVE 47%", ru: "ВЫГОДНО · -47%" },
    "paywall.startTrial": { en: "Start 7-day free trial", ru: "Начать 7-дневный пробный период" },
    "paywall.smallPrint": {
      en: "7-day free trial, then auto-renews. Cancel anytime in App Store / Google Play settings.",
      ru: "7 дней бесплатно, затем авто-продление. Отменить можно в любой момент в App Store / Google Play.",
    },
    "paywall.restore": { en: "Restore purchases", ru: "Восстановить покупки" },
    "paywall.terms": { en: "Terms", ru: "Условия" },
    "paywall.privacy": { en: "Privacy", ru: "Приватность" },
    "paywall.noPurchases": { en: "No active subscription found.", ru: "Активная подписка не найдена." },

    // Settings → Subscription section
    "settings.subTitle": { en: "Subscription", ru: "Подписка" },
    "settings.subStatusPro": { en: "FORGE Pro — active", ru: "FORGE Pro — активна" },
    "settings.subStatusTrial": { en: "FORGE Pro — trial", ru: "FORGE Pro — пробный период" },
    "settings.subStatusFree": { en: "Free plan", ru: "Бесплатный план" },
    "settings.subUsedThisWeek": { en: "{used} of {limit} workouts saved this week", ru: "{used} из {limit} тренировок сохранено за неделю" },
    "settings.subRenewsOn": { en: "Renews on {date}", ru: "Продление {date}" },
    "settings.subTrialEndsOn": { en: "Trial ends {date}", ru: "Пробный период до {date}" },
    "settings.subUpgrade": { en: "Upgrade to Pro", ru: "Перейти на Pro" },
    "settings.subManage": { en: "Manage subscription", ru: "Управление подпиской" },
    "settings.subRestore": { en: "Restore purchases", ru: "Восстановить покупки" },
    ...
    "wo.guideExtend": { en: "Aim for <strong>{target} reps</strong> — you've topped out the usual {range}, so keep adding reps to progress.", ru: "Цель: <strong>{target} повт.</strong> — обычный диапазон {range} исчерпан; прибавляй повторы, чтобы прогрессировать." },
    "wo.guideEffort": { en: "You left reps in the tank last time — push closer to failure, aim for <strong>{target}+ reps</strong>.", ru: "В прошлый раз остался запас — работай ближе к отказу, цель <strong>{target}+ повт.</strong>" },
    "wo.stimulusTip": { en: "💡 Maxed on load and reps here. For a fresh stimulus try a slow 3-sec lowering, a harder variation, or an extra set — instead of just more reps.", ru: "💡 Здесь предел и по весу, и по повторам. Для нового стимула попробуй медленную фазу опускания (3 сек), более сложный вариант или лишний подход — вместо просто новых повторов." },
